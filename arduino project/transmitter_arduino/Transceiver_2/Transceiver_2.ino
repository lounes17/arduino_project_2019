...
const uint64_t pipe[4]={0xABABABABD1LL, 0x1212121278LL, 0x1212121234LL, 0x1212121299LL};
RF24 radio(48,49);
int i=0;
char re=0;
char income[32];
...
void print_welcome_message()
{
     ...
     Serial.print(",You want to send a Message(Transc1= 1, Transc3= 2\n");
...
void loop()
{
  ...
  }else if(radio.available(&pipe_num))
  {
    bool done=false;
     ...
     if(sender_id==1)
      {
      Serial.print("From Transceiver 1");
      Serial.println();
      }else if(sender_id==2)
      {
